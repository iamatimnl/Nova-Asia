...
def orders_to_dicts(orders):
    ...
    for o in orders:
        ...
        # 计算配送费兜底
        discount = o.discount_amount or o.next_discount_amount or 0
...
def api_orders():
    try:
        ...
        if discount_code and customer_email:
            ...
            db.session.commit()
            print(
                f"✅ 折扣码保存成功: {discount_code} for {customer_email} met korting {next_discount_amount}"
            )
